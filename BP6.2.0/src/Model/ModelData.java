...
public class ModelData {
    ...
    public static int eindX;
    public static int eindY;
    public static int testCount = 0;
    public static String richting = "oost";
    ...
    public static String whiles = "Testing";
    public static int sRow = 0;
    public static int sCol = 0;
    public static int gridX;
    public static int gridY;

    public static int getEindX() {
        return eindX;
    }

    public static void setEindX(int eindX) {
        ModelData.eindX = eindX;
    }

    public static int getEindY() {
        return eindY;
    }

    public static void setEindY(int eindY) {
        ModelData.eindY = eindY;
    }
